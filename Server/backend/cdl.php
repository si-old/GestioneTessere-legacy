...
class CdL extends RESTItem
{
    ...
    protected function do_get()
    {
        ...
        $this->logger->debug($this->session->get_user(), 'Ricerca di tutti i Corsi di Laurea.');
        return $res;
    }
	...
	*/
    protected function do_post($data)
    {
        ...
        if ($valid) {
            ...
            $this->logger->info($this->session->get_user(), 'Aggiornato/Aggiunto Corso di Laurea.');
            return $this->do_get();
        } else {
    ...
    protected function do_del()
    {
        if ($this->has_id) {
            ...
            $this->logger->info($this->session->get_user(),'Rimosso Corso di Laurea con id $this->id.');
            return $this->do_get();
        } else {
